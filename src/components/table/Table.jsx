...
const Table = ({ playerData, playerHeading ,onEditProfile }) => {
...
const handleNavigate = (item, i) => {
  if (item.playerName) {
    navigate('/profile', { state: { selectedPerson: item, selectedIndex: i } });
...
// const Table = ({ playerData, playerHeading, handleEditedProfile }) => {
//   const [selectedItem, setSelectedItem] = useState(null);
//   const [selectedIndex, setSelectedIndex] = useState(null);
//   const [showTournamentModel, setShowTournamentModel] = useState(false);
...
//     if (item.playerName) {
//       navigate('/profile', { state: { selectedPerson: item, selectedIndex: index, handleEditedProfile } });
//       setSelectedItem(item);
